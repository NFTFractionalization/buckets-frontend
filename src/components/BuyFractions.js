...
function BuyFractions(props) {
    ...
    return (
        <div className="bg-black text-white text-center content-center">
            <h1 className="text-5xl text-transparent bg-clip-text bg-gradient-to-tl from-[#CE4DA4] to-[#7353E5] text-semibold">Buy Fractions</h1>
